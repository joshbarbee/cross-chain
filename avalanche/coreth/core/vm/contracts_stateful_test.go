...
func Transfer(db StateDB, sender, recipient common.Address, amount *big.Int, prefetch bool, depth int) {
	db.SubBalance(sender, amount)
	db.AddBalance(recipient, amount)
}

// Transfer subtracts amount from sender and adds amount to recipient using the given Db
func TransferMultiCoin(db StateDB, sender, recipient common.Address, coinID common.Hash, amount *big.Int, prefetch bool, depth int) {
