...
import (
	...
	"github.com/ava-labs/coreth/mgologger"
...
type (
	...
	TransferFunc   func(StateDB, common.Address, common.Address, *big.Int, bool, int)
	TransferMCFunc func(StateDB, common.Address, common.Address, common.Hash, *big.Int, bool, int)
...
func (evm *EVM) CallExpert(caller ContractRef, addr common.Address, input []byte, gas uint64, value *big.Int, coinID common.Hash, value2 *big.Int) (ret []byte, leftOverGas uint64, err error) {
	...
	evm.Context.Transfer(evm.StateDB, caller.Address(), addr, value, evm.prefetch, evm.depth)
	evm.Context.TransferMultiCoin(evm.StateDB, caller.Address(), addr, coinID, value2, evm.prefetch, evm.depth)
